...
{\Huge CHANGED TO ADDRESS: This isn't quite right -- process doesn't start *at* a physical
  meeting -- it starts *before* the meeting}

The ratification process of a new MPI Standard Document must start at the end of
a physical meeting; only changes voted into the MPI Standard Document
up to the end of that meeting (either using a single vote in case of erratas or a
...
%MS: removed consecutive - quorum issues?

The ratification process then requires ballots at two following physical MPI forum
